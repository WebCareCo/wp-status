...
Description: Save important system information into the database in JSON format, including firewall activity from NinjaFirewall and Defender, and recent site activity from Simple History.
Version: 1.15
Author: WebCare
